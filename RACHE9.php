...
<br>          
<center><p>BY - ”baba booey” <span></span></p></center>
<br>
";
...
<font color='green'><hr>DONE : $d2<hr></font></center></div>";
} else {
...
<font color='red'><hr>$cc<hr></font></center></div>";
		...
		<div class="container p-5 ">
			<form action="" method="get">
				...
				<div class="mb-3">
					...
					<div  class="form-text">Enter Your user_id</div>
	...
	<section>
		<div class="container p-2 text-center">
			<button onclick="location.href='http://t.me/HQ_7_W'" class="btn btn-primary rounded-circle icon-btn"><i class="fa fa-telegram"></i></button>
			<button onclick="location.href='https://www.instagram.com/ussa._.ma20'" class="btn btn-primary rounded-circle icon-btn"><i class="fa fa-instagram"></i></button>
			<p class="text-muted p-5">SUBSCRIBE</p>
			
		</div>
		
	</section>
	<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="HQ_7_W"></script>
